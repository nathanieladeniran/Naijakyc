<!DOCTYPE html>
<html lang="en">
<?php $title="Terms and Conditions"; include('partial/header.prt.php'); include('app-settings.php'); ?>
<body>
        ...
        <div class="container position-relative zindex-100">
            <div class="row justify-content-center mb-5">
                <div class="col-lg-6 text-center">
                    ...
                    <p class="lh-190">Last updated: June 16, 2022</p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    ●	Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nigeria KYC, Nigeria.<br />
                    ...
                    ●	Website refers to nigeriakyc.com, accessible from nigeriakyc.com.<br />
                    ...
                    ●	By email: <strong>hello@nigeriakyc.com</strong>
